...
class App:
    ...
    def draw_grid(self, visited=None, frontier=None):
        ...
        pygame.draw.rect(self.screen, CYAN,
                         (self.grid.start[1]*self.cell, self.grid.start[0]*self.cell,
                          self.cell, self.cell))
        pygame.draw.rect(self.screen, PURPLE,
                         (self.grid.goal[1]*self.cell, self.grid.goal[0]*self.cell,
                          self.cell, self.cell))
        pygame.draw.rect(self.screen, ORANGE,
                         (self.agent_pos[1]*self.cell, self.agent_pos[0]*self.cell,
                          self.cell, self.cell))
    ...
    def start_search(self):
        ...
        self.exec_time = (time.time() - self.start_time) * 1000
        if path:
            self.path = path
